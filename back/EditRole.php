            ...
            <tr>
                ...
                <?php if( count($access_arr) ):?>
                    ...
                    <?php foreach($access_arr as $access): ?>
                            <div>
            <input type="checkbox" <?php checked($access['access_id'],$role_access_info);?> name="access[]" value="<?php echo $access['access_id']?>"><?php echo $access['access_title']."-".$access['access_action'] ?>
                            </div>
                    <?php endforeach; ?>
                        </td>
                <?php endif; ?>
